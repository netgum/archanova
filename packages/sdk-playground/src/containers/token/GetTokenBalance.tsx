...
sdk
  .getTokenBalance(symbolOrAddress)
  .then(tokenBalance => console.log('tokenBalance', tokenBalance))
  .catch(console.error);
`;
...
export class GetTokenBalance extends Screen<IState> {
  public state = {
    symbolOrAddress: 'ETK',
  };
  ...
  private run(): void {
    ...
    this
      .logger
      .wrapSync('sdk.getTokenBalance', async (console) => {
        console.log('tokenBalance', await this.sdk.getTokenBalance(symbolOrAddress));
      });
  }
}
